...
export default function Activity() {
  ...
  const ActivityCard = ({ activity }) => {
    ...
    return (
      <motion.div
        ...
        whileHover={{ y: -2 }}
        className={`relative bg-white/80 dark:bg-[#13101A]/80 backdrop-blur-xl rounded-3xl p-4 lg:p-6 border border-gray-200/50 dark:border-purple-900/20 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden group`}
      >
        {/* Background Pattern */}
        <div
          className={`absolute inset-0 bg-gradient-to-br ${activityConfig.bgGradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
        ></div>
        ...
        <div className="relative z-10">
          <div className="flex items-start space-x-4">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/30 dark:to-blue-900/30 rounded-2xl overflow-hidden border-2 border-gray-200/50 dark:border-purple-700/30 group-hover:border-purple-400/50 transition-colors">
                {imageUrl && !imageError ? (
                  <img
                    src={imageUrl}
                  ...
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-purple-500/20 to-blue-500/20">
                    <FiImage className="w-6 h-6 lg:w-8 lg:h-8 text-purple-500 dark:text-purple-400" />
                  </div>
                )}
              </div>
              ...
              <div
                className={`absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-br ${
                  activityConfig.color === "blue"
                    ? "from-blue-500 to-cyan-500"
                    : activityConfig.color === "green"
                    ? "from-green-500 to-emerald-500"
                    : activityConfig.color === "orange"
              ...
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-3 lg:space-y-0">
                <div className="flex-1 space-y-2">
                  ...
                  <div className="flex items-center space-x-3">
                    <span
                      className={`px-3 py-1.5 rounded-xl text-xs font-semibold bg-gradient-to-r ${
                        activityConfig.color === "blue"
                          ? "from-blue-100 to-cyan-100 text-blue-700 dark:from-blue-900/30 dark:to-cyan-900/30 dark:text-blue-300"
                          : activityConfig.color === "green"
                          ? "from-green-100 to-emerald-100 text-green-700 dark:from-green-900/30 dark:to-emerald-900/30 dark:text-green-300"
                          : activityConfig.color === "orange"
                          ? "from-orange-100 to-yellow-100 text-orange-700 dark:from-orange-900/30 dark:to-yellow-900/30 dark:text-orange-300"
                          : "from-purple-100 to-pink-100 text-purple-700 dark:from-purple-900/30 dark:to-pink-900/30 dark:text-purple-300"
                      }`}
                    >
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
                    {localMetadata?.description || activity.description}
                  </p>

                  {/* User Information */}
                  <div className="flex flex-wrap items-center gap-4 text-xs">
                    <div className="flex items-center space-x-2 bg-gray-100/50 dark:bg-gray-800/50 px-3 py-1.5 rounded-xl">
                    ...
                    {activity.buyer && (
                      <>
                        ...
                        <div className="flex items-center space-x-2 bg-green-100/50 dark:bg-green-800/20 px-3 py-1.5 rounded-xl">
                ...
                {activity.price && paymentConfig && (
                  <div className="flex-shrink-0">
                    <div
                      className={`${paymentConfig.bg} ${paymentConfig.color} px-4 py-2.5 rounded-2xl border border-gray-200/50 dark:border-gray-700/30 backdrop-blur-sm`}
                    >
  ...
  if (loading) {
    return (
      <Layout
        title="Activity"
        subtitle="Track marketplace activities and discover trending NFTs"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
    ...
    >
        ...
        <div className="relative z-10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              >
                Stay updated with the latest marketplace activities, track NFT
                transactions, and discover trending digital assets
              </motion.p>
            </div>
            ...
            >
              {[
                { icon: FiZap, text: "Real-time Updates", color: "blue" },
                { icon: FiBarChart, text: "Analytics", color: "green" },
                { icon: FiShield, text: "Verified Data", color: "purple" },
              ].map((feature, index) => (
                <div
                  key={index}
      ...
      >
        ...
        <StatsCard
          ...
          value={(stats.totalListed || 0).toString()}
            ...
            {(searchQuery || filter !== "all") && (
              ...
              >
                ...
                {filter !== "all" && (
                  ...
                  >
                    <span>
                      Filter: {ACTIVITY_TYPES[filter]?.label || filter}
                    </span>
                    <button
